...
$anchor_id = 'job-item-' . $item->id;
?>
<div id="<?php echo $anchor_id; ?>" class="jobs-item item<?php echo $item->state == 0 ? ' well well-small' : null; ?>">
	<div class="jobs-item-inner">
		...
		<div class="row-fluid">
			<div class="span12">
				<p></p>
				<p class="readmore">
					<?php echo JHtml::_('link', $item->link, JText::_('COM_JOBS_READMORE'), array('class' => 'btn btn-small btn-primary')); ?>
				</p>
			</div>
		</div>
		<!-- ============================================================================= -->
